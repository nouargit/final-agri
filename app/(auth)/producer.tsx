...
export default function Producer() {
  ...
  const role = "producer"; // Fixed role for this screen
            ...
            <View className="mb-8">
              <View className="flex-row items-start mb-4">
                <View className="bg-primary/10 p-2 rounded-lg mr-3">
                  <TrendingUp size={20} color="#22680C" />
                </View>
                <View className="flex-1">
                  ...
                  <Text className="text-sm text-neutral-600 mt-1">
                    Reach more customers and sell your products directly
                  </Text>
                </View>
              </View>
              ...
              <View className="flex-row items-start mb-4">
                ...
                <View className="flex-1">
                  ...
                  <Text className="text-sm text-neutral-600 mt-1">
                    Connect with buyers, transporters, and other producers
                  </Text>
                </View>
              </View>
              ...
              <View className="flex-row items-start">
                ...
                <View className="flex-1">
                  ...
                  <Text className="text-sm text-neutral-600 mt-1">
                    Easy-to-use tools for listing and managing your inventory
                  </Text>
                </View>
              </View>
            </View>
